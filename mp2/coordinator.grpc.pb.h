 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status create(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::csce438::Status* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>> Asynccreate(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>>(AsynccreateRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>> PrepareAsynccreate(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>>(PrepareAsynccreateRaw(context, request, cq));
    }
    // Check if a path exists (checking if a Master is elected
    virtual ::grpc::Status exists(::grpc::ClientContext* context, const ::csce438::Path& request, ::csce438::Status* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>> Asyncexists(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>>(AsyncexistsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>> PrepareAsyncexists(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>>(PrepareAsyncexistsRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      // ZooKeeper API here
      // Create a path and place data in the znode
      virtual void create(::grpc::ClientContext* context, const ::csce438::PathAndData* request, ::csce438::Status* response, std::function<void(::grpc::Status)>) = 0;
      virtual void create(::grpc::ClientContext* context, const ::csce438::PathAndData* request, ::csce438::Status* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // Check if a path exists (checking if a Master is elected
      virtual void exists(::grpc::ClientContext* context, const ::csce438::Path* request, ::csce438::Status* response, std::function<void(::grpc::Status)>) = 0;
      virtual void exists(::grpc::ClientContext* context, const ::csce438::Path* request, ::csce438::Status* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>* AsynccreateRaw(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>* PrepareAsynccreateRaw(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>* AsyncexistsRaw(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::csce438::Status>* PrepareAsyncexistsRaw(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status create(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::csce438::Status* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>> Asynccreate(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>>(AsynccreateRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>> PrepareAsynccreate(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>>(PrepareAsynccreateRaw(context, request, cq));
    }
    ::grpc::Status exists(::grpc::ClientContext* context, const ::csce438::Path& request, ::csce438::Status* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>> Asyncexists(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>>(AsyncexistsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>> PrepareAsyncexists(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::csce438::Status>>(PrepareAsyncexistsRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void create(::grpc::ClientContext* context, const ::csce438::PathAndData* request, ::csce438::Status* response, std::function<void(::grpc::Status)>) override;
      void create(::grpc::ClientContext* context, const ::csce438::PathAndData* request, ::csce438::Status* response, ::grpc::ClientUnaryReactor* reactor) override;
      void exists(::grpc::ClientContext* context, const ::csce438::Path* request, ::csce438::Status* response, std::function<void(::grpc::Status)>) override;
      void exists(::grpc::ClientContext* context, const ::csce438::Path* request, ::csce438::Status* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::csce438::Status>* AsynccreateRaw(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::csce438::Status>* PrepareAsynccreateRaw(::grpc::ClientContext* context, const ::csce438::PathAndData& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::csce438::Status>* AsyncexistsRaw(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::csce438::Status>* PrepareAsyncexistsRaw(::grpc::ClientContext* context, const ::csce438::Path& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // ZooKeeper API here
    // Create a path and place data in the znode
    virtual ::grpc::Status create(::grpc::ServerContext* context, const ::csce438::PathAndData* request, ::csce438::Status* response);
    // Check if a path exists (checking if a Master is elected
    virtual ::grpc::Status exists(::grpc::ServerContext* context, const ::csce438::Path* request, ::csce438::Status* response);
  };
  ...
  class WithAsyncMethod_create : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status create(::grpc::ServerContext* /*context*/, const ::csce438::PathAndData* /*request*/, ::csce438::Status* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void Requestcreate(::grpc::ServerContext* context, ::csce438::PathAndData* request, ::grpc::ServerAsyncResponseWriter< ::csce438::Status>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_exists : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status exists(::grpc::ServerContext* /*context*/, const ::csce438::Path* /*request*/, ::csce438::Status* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void Requestexists(::grpc::ServerContext* context, ::csce438::Path* request, ::grpc::ServerAsyncResponseWriter< ::csce438::Status>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_create() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::csce438::PathAndData, ::csce438::Status>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::csce438::PathAndData* request, ::csce438::Status* response) { return this->create(context, request, response); }));}
    void SetMessageAllocatorFor_create(
        ::grpc::MessageAllocator< ::csce438::PathAndData, ::csce438::Status>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(2);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::csce438::PathAndData, ::csce438::Status>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* create(
      ::grpc::CallbackServerContext* /*context*/, const ::csce438::PathAndData* /*request*/, ::csce438::Status* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_exists() {
      ::grpc::Service::MarkMethodCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::csce438::Path, ::csce438::Status>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::csce438::Path* request, ::csce438::Status* response) { return this->exists(context, request, response); }));}
    void SetMessageAllocatorFor_exists(
        ::grpc::MessageAllocator< ::csce438::Path, ::csce438::Status>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(3);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::csce438::Path, ::csce438::Status>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* exists(
      ::grpc::CallbackServerContext* /*context*/, const ::csce438::Path* /*request*/, ::csce438::Status* /*response*/)  { return nullptr; }
  };
   ...
   public:
    WithStreamedUnaryMethod_create() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler<
          ::csce438::PathAndData, ::csce438::Status>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::csce438::PathAndData, ::csce438::Status>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status Streamedcreate(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::csce438::PathAndData,::csce438::Status>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_exists() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::internal::StreamedUnaryHandler<
          ::csce438::Path, ::csce438::Status>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::csce438::Path, ::csce438::Status>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status Streamedexists(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::csce438::Path,::csce438::Status>* server_unary_streamer) = 0;
  };
