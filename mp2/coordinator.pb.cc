...
const ::uint32_t TableStruct_coordinator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::csce438::ServerList, _impl_.serverlist_),
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::csce438::SynchService, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::csce438::SynchService, _impl_.idkwhat_),
    ~0u,  // no _has_bits_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::csce438::Status, _impl_.status_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, -1, -1, sizeof(::csce438::ServerInfo)},
        { 12, -1, -1, sizeof(::csce438::Confirmation)},
        { 21, -1, -1, sizeof(::csce438::ID)},
        { 30, -1, -1, sizeof(::csce438::ServerList)},
        { 39, -1, -1, sizeof(::csce438::SynchService)},
        { 48, -1, -1, sizeof(::csce438::PathAndData)},
        { 58, -1, -1, sizeof(::csce438::Path)},
        { 67, -1, -1, sizeof(::csce438::Status)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
    ...
    &::csce438::_SynchService_default_instance_._instance,
...
const char descriptor_table_protodef_coordinator_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "ist\022\022\n\nserverList\030\001 \003(\t\"\037\n\014SynchService\022"
    "\017\n\007idkwhat\030\001 \001(\t\")\n\013PathAndData\022\014\n\004path\030"
    ...
    "sce438.ID\032\023.csce438.ServerInfo\"\000\0221\n\006crea"
    "te\022\024.csce438.PathAndData\032\017.csce438.Statu"
    "s\"\000\022*\n\006exists\022\r.csce438.Path\032\017.csce438.S"
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          do {
            ...
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "csce438.ServerList.serverList"));
...
::uint8_t* ServerList::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_serverlist_size(); i < n; ++i) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce438.ServerList.serverList");
...
SynchService::SynchService(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:csce438.SynchService)
}
SynchService::SynchService(const SynchService& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.idkwhat_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        _impl_.idkwhat_.Set("", GetArenaForAllocation());
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_idkwhat().empty()) {
    _this->_impl_.idkwhat_.Set(from._internal_idkwhat(), _this->GetArenaForAllocation());
  }
  // @@protoc_insertion_point(copy_constructor:csce438.SynchService)
}
...
SynchService::~SynchService() {
  // @@protoc_insertion_point(destructor:csce438.SynchService)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:csce438.SynchService)
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_idkwhat();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "csce438.SynchService.idkwhat"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* SynchService::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:csce438.SynchService)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // string idkwhat = 1;
  if (!this->_internal_idkwhat().empty()) {
    const std::string& _s = this->_internal_idkwhat();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce438.SynchService.idkwhat");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:csce438.SynchService)
  return target;
}

::size_t SynchService::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:csce438.SynchService)
  ::size_t total_size = 0;
...
void SynchService::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:csce438.SynchService)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (!from._internal_idkwhat().empty()) {
    _this->_internal_set_idkwhat(from._internal_idkwhat());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void SynchService::CopyFrom(const SynchService& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:csce438.SynchService)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void SynchService::InternalSwap(SynchService* other) {
  ...
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.idkwhat_, lhs_arena,
                                       &other->_impl_.idkwhat_, rhs_arena);
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "csce438.PathAndData.path"));
        } else {
          goto handle_unusual;
        }
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "csce438.PathAndData.data"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* PathAndData::_InternalSerialize(
  ...
  if (!this->_internal_path().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce438.PathAndData.path");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  if (!this->_internal_data().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce438.PathAndData.data");
    target = stream->WriteStringMaybeAliased(2, _s, target);
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "csce438.Path.path"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* Path::_InternalSerialize(
  ...
  if (!this->_internal_path().empty()) {
    const std::string& _s = this->_internal_path();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce438.Path.path");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
...
template<> PROTOBUF_NOINLINE ::csce438::SynchService*
Arena::CreateMaybeMessage< ::csce438::SynchService >(Arena* arena) {
  return Arena::CreateMessageInternal< ::csce438::SynchService >(arena);
}
...
template<> PROTOBUF_NOINLINE ::csce438::Status*
Arena::CreateMaybeMessage< ::csce438::Status >(Arena* arena) {
  return Arena::CreateMessageInternal< ::csce438::Status >(arena);
}
