...
template <>
::csce438::Status* Arena::CreateMaybeMessage<::csce438::Status>(Arena*);
template <>
::csce438::SynchService* Arena::CreateMaybeMessage<::csce438::SynchService>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class SynchService final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:csce438.SynchService) */ {
 public:
  ...
  enum : int {
    kIdkwhatFieldNumber = 1,
  };
  // string idkwhat = 1;
  void clear_idkwhat() ;
  const std::string& idkwhat() const;




  template <typename Arg_ = const std::string&, typename... Args_>
  void set_idkwhat(Arg_&& arg, Args_... args);
  std::string* mutable_idkwhat();
  PROTOBUF_NODISCARD std::string* release_idkwhat();
  void set_allocated_idkwhat(std::string* ptr);

  private:
  const std::string& _internal_idkwhat() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_idkwhat(
      const std::string& value);
  std::string* _internal_mutable_idkwhat();

  public:
  // @@protoc_insertion_point(class_scope:csce438.SynchService)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr idkwhat_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_coordinator_2eproto;
...
class PathAndData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:csce438.PathAndData) */ {
 public:
...
class Path final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:csce438.Path) */ {
 public:
...
class Status final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:csce438.Status) */ {
 public:
...
inline std::string* ServerList::add_serverlist() {
  ...
  // @@protoc_insertion_point(field_add_mutable:csce438.ServerList.serverList)
  return _s;
}
inline const std::string& ServerList::serverlist(int index) const {
  // @@protoc_insertion_point(field_get:csce438.ServerList.serverList)
  return _internal_serverlist(index);
}
inline std::string* ServerList::mutable_serverlist(int index) {
  // @@protoc_insertion_point(field_mutable:csce438.ServerList.serverList)
...
inline void ServerList::set_serverlist(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:csce438.ServerList.serverList)
}
...
inline void ServerList::set_serverlist(int index, const char* value) {
  ...
  _internal_mutable_serverlist()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:csce438.ServerList.serverList)
}
inline void ServerList::set_serverlist(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_serverlist()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:csce438.ServerList.serverList)
}
inline void ServerList::set_serverlist(int index, absl::string_view value) {
  _internal_mutable_serverlist()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:csce438.ServerList.serverList)
}
inline void ServerList::add_serverlist(const std::string& value) {
  _internal_mutable_serverlist()->Add()->assign(value);
  // @@protoc_insertion_point(field_add:csce438.ServerList.serverList)
}
...
inline void ServerList::add_serverlist(const char* value) {
  ABSL_DCHECK(value != nullptr);
  _internal_mutable_serverlist()->Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:csce438.ServerList.serverList)
}
inline void ServerList::add_serverlist(const char* value, std::size_t size) {
  _internal_mutable_serverlist()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:csce438.ServerList.serverList)
}
inline void ServerList::add_serverlist(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:csce438.ServerList.serverList)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ServerList::serverlist() const {
  // @@protoc_insertion_point(field_list:csce438.ServerList.serverList)
  return _internal_serverlist();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* ServerList::mutable_serverlist() {
  // @@protoc_insertion_point(field_mutable_list:csce438.ServerList.serverList)
...
// string idkwhat = 1;
inline void SynchService::clear_idkwhat() {
  _impl_.idkwhat_.ClearToEmpty();
}
inline const std::string& SynchService::idkwhat() const {
  // @@protoc_insertion_point(field_get:csce438.SynchService.idkwhat)
  return _internal_idkwhat();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void SynchService::set_idkwhat(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.idkwhat_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:csce438.SynchService.idkwhat)
}
inline std::string* SynchService::mutable_idkwhat() {
  std::string* _s = _internal_mutable_idkwhat();
  // @@protoc_insertion_point(field_mutable:csce438.SynchService.idkwhat)
  return _s;
}
inline const std::string& SynchService::_internal_idkwhat() const {
  return _impl_.idkwhat_.Get();
}
inline void SynchService::_internal_set_idkwhat(const std::string& value) {
  ;


  _impl_.idkwhat_.Set(value, GetArenaForAllocation());
}
inline std::string* SynchService::_internal_mutable_idkwhat() {
  ;
  return _impl_.idkwhat_.Mutable( GetArenaForAllocation());
}
inline std::string* SynchService::release_idkwhat() {
  // @@protoc_insertion_point(field_release:csce438.SynchService.idkwhat)
  return _impl_.idkwhat_.Release();
}
inline void SynchService::set_allocated_idkwhat(std::string* value) {
  _impl_.idkwhat_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.idkwhat_.IsDefault()) {
          _impl_.idkwhat_.Set("", GetArenaForAllocation());
        }
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:csce438.SynchService.idkwhat)
}
...
inline bool Status::status() const {
  // @@protoc_insertion_point(field_get:csce438.Status.status)
  return _internal_status();
}
inline void Status::set_status(bool value) {
  _internal_set_status(value);
  // @@protoc_insertion_point(field_set:csce438.Status.status)
}
